...
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Sorry Blogs is not Update in Database
</div>";
 }
                                 ...
                                 <form method="post" action="" enctype="multipart/form-data">
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="short_content" class="form-control" value="<?php  echo $row['short_content']?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="post_status" class="form-control" value="<?php  echo $row['post_status']?>">
                                            </div>
                                            <br>
