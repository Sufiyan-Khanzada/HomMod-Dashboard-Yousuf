...
if(isset($_POST['updatevid']))
{
    ...
    $items = $_POST['items'];
      ...
      // Upload file
       ...
       $query="UPDATE build_box SET name='$name',price='$price', items='$items' WHERE id='$upd_id'";
...
$result_query=mysqli_query($conn,$query);
  ...
  <strong>Success!</strong> Build box Updated Done Succesfully.
</div>";

}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Sorry Build box is not Update in Database
</div>";
 }
            ...
            <div class="body d-flex py-3">
                <div class="container-xxl">
                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0"> Edit Build A Box</h3>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <?php
                     $id=$_GET['id'];
                    $sql = "SELECT * FROM  build_box where id=$id";
                                 ...
                                 <form method="post" action="" enctype="multipart/form-data">
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="items" class="form-control" value="<?php  echo $row['items']?>">
                                            </div>
                                            <br>
