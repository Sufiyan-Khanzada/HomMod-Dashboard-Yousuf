...
if(isset($_POST['updatevid']))
{
    ...
    $package_price = $_POST['package_price'];
      ...
      // Upload file
       ...
       $query="UPDATE package SET package_name='$package_name',package_desc='$package_desc', package_price='$package_price' WHERE id='$upd_id'";
...
$result_query=mysqli_query($conn,$query);
  ...
  <strong>Success!</strong> Package Updated Done Succesfully.
</div>";

}
else{
$msg="<div class='alert alert-danger'>
  <strong>Warning!</strong> Sorry Package is not Update in Database
</div>";
 }
                                        ...
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <input type="text" name="package_name" class="form-control" value="<?php  echo $row['package_name']?>">
                                            </div> 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="package_price" class="form-control" value="<?php  echo $row['package_price']?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="package_desc" class="form-control" value="<?php  echo $row['package_desc']?>">
                                            </div>
                                            <br>
